...
The `@repo/view` package provides a schema-driven approach to building UI components with integrated CRUD functionality, internationalization support, and error handling.
...
- [Designer](/packages/view/designer) - Visual designer for creating view schemas
