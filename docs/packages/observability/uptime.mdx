...
When you create your project, I recommend adding some specific URLs to monitor. Assuming we're using `zopio.com` and it's subdomains, here's what you should add:
