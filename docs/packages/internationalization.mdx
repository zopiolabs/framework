...
<Tip>
  [Languine](https://dub.sh/0KOndf7) offers 500 translation keys for free. If you need more, you can upgrade to a paid plan with the discount code `zopio` for 30% off!
</Tip>
